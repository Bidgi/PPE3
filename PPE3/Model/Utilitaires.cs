...
namespace PPE3.Classe
{
    public class Utilitaires
    {
        ...
        public static PdfDocument NewLivret(string nom, string prenom)
        {
            ...
            Utilitaires.RangeValue(listStageEtudiant.ElementAt(0).ElementAt(1) +"\n"+ listStageEtudiant.ElementAt(0).ElementAt(2), "F4", "F4", WorksheetVerso, 12, true);
            Utilitaires.RangeValue(listStageEtudiant.ElementAt(0).ElementAt(3), "G4", "K4", WorksheetVerso, 12, true);
            Utilitaires.RangeValue("", "L4", "M4", WorksheetVerso, 12, true);
            ...
            Utilitaires.RangeValue(listStageEtudiant.ElementAt(1).ElementAt(1) + "\n" + listStageEtudiant.ElementAt(1).ElementAt(2), "F5", "F5", WorksheetVerso, 12, true);
            Utilitaires.RangeValue(listStageEtudiant.ElementAt(1).ElementAt(3), "G5", "K5", WorksheetVerso, 12, true);
            Utilitaires.RangeValue("", "L5", "M5", WorksheetVerso, 12, true);
